...
<head>
    ...
    <title>Url Shortener | Requirements</title>
    <style type="text/css">
        body
        {
            background: white;
...
<div id="page">
    ...
    <div id="content">
        ...
        <p>
            ...
            for running <a href="http://short.php8developer.com">Url Shortener</a>.
        ...
        <p>
            <?php if($result>0): ?>
                Congratulations! Your server configuration satisfies minimum requirements by Url Shortener.
            <?php else: ?>
                Unfortunately your server configuration does not satisfy the requirements by Url Shortener.
            <?php endif; ?>
        </p>
