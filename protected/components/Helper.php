...
class Helper {
    ...
    public static function f($number, $decimal=0) {
        return number_format($number, $decimal, Yii::app()->params['app.dec_point'], Yii::app()->params['app.thousands_sep']);
    }

    public static function cropText($text, $length = 50, $separator = '...') {
