...
class Channels {
    ...
    public function create(Request $body){
        ...
        if(DB::channels()->where('userid', $user->rID())->where('name', clean($request->name))->first()){
            return Response::factory(['error' => 1, 'message' => 'You already have a channel with this name.'])->json();
        }
