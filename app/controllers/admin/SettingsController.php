...
class Settings {
    ...
    public function verify(Request $request){
        ...
        if(!$response || empty($response) || $response == "Failed"){
            ...
            return back()->with("danger", "This purchase code is already used on another domain. If you need to reset it, please contact us with your purchase code and domain name to reset it.");
