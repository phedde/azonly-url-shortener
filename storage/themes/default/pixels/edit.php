<div class="d-flex">
    <div>
        <h1 class="h3 mb-5"><img src="<?php echo assets('images/'.str_replace(['pixel','fb'], ['', 'facebook'], $pixel->type).'.svg') ?>" width="45" class="me-2"> <?php echo $pixel->name ?> (<?php echo \Helpers\App::pixelName($pixel->type) ?>)</h1>
    </div>
    <div class="ms-auto">
